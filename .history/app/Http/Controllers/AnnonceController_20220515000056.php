...
class AnnonceController extends Controller
{
    ...
    public function voiture_details($id)
    {
        $annonces_voiture =  array();
        $voitures = null;
        $conversations=Conversation::with('userConversation')->where([['partenaire_id',Auth::user()->id],['annonce_id',$id]])->get();
       // dd($conversations->toArray());
        ...
        return view('partenaire.annonce_details', ['annonces_voiture'=>$annonces_voiture,'conversations'=>$conversations]);
    }
