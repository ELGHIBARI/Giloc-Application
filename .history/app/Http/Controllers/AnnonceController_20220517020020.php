...
class AnnonceController extends Controller
{
    ...
    public function moto_details($id)
    {
        ...
        //dd($conversations);
        return view('partenaire.annonce_details', ['annonces_moto' => $annonces_moto, 'demandes' => $demandes,'client'=>$client,'conversations' => $conversations, 'lastMessages' => $lastMessages]);
    }
