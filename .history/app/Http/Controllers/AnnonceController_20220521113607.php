...
class AnnonceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($annonce->date_debut == date('Y-m-d H:i:s'))
            $etat = 'activee';
        else
            $etat = 'archivee';
    ...
    {   // récupérer les conversations
        ...
        //rating
        $rating = Evaluation_objet::with('client')->where([['annonce_id', $id], ['type_vehicule', 'voiture']])->orderBy('evaluation_etoile', 'desc')->get();
    ...
    public function moto_details($id)
    {
        ...
        //rating
        $rating = Evaluation_objet::with('client')->where([['annonce_id', $id], ['type_vehicule', 'moto']])->orderBy('evaluation_etoile', 'desc')->get();
        $rating = $rating->toArray();
    ...
    public function evaluation_velo($id)
    {
        ...
        //rating
        $rating = Evaluation_objet::with('client')->where([['annonce_id', $id], ['type_vehicule', 'velo']])->orderBy('evaluation_etoile', 'desc')->get();
        $rating = $rating->toArray();
        //-------
