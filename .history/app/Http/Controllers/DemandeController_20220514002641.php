...
class DemandeController extends Controller
{
  ...
  {
    $demandes = Demande::with('userAnnonce')->where('etat_demande', 0)->get();
    $invoices = Demande::with(array('userAnnonce' => function($query) {
  ...
  {
    $Annonces = Demande::with('userAnnonce')->where([['user_id', Auth::user()->id], ['id', $id_annonce]])->get();
    $Annonce = null;
    $images = null;
