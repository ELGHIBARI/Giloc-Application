...
class DemandeController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $demande->save();
    $annonce = Annonce::find($demande->annonce_id)->update(['disponible' => 0]);
    //dd($annonce);
    return redirect('/acceuil');
  }
  //with('success','Successfully registered a new student!');
  ...
  public function mesReservation()
  {
    ...
    //  $annonces = Annonce::where('id',$demand->annonce_id)->get();
    // dd($annonces);
