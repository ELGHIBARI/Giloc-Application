...
class DemandeController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $demande->save();
    $a=Demande::with('userDemande','userAnnonce')->where('annonce_id',$demande->annonce_id)->get();
    $user=User::find($a->userAnnonce->user_id);
    $user->notify(new DemandeNotification($a));
