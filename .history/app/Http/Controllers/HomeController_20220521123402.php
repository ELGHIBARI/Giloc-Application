...
class HomeController extends Controller
{
    ...
    public function rechercherCategorie()
    {
        ...
        if ($rech == "voiture") {
            ...
            return (new HomeController)->acceuil();
        }
    }
    ...
    public function rechercherCategorieLanding()
    {
        $rech = $_GET['search'];
        if ($rech == "voiture") {
            return (new HomeController)->showVoitureLanding();
        } else if ($rech == "moto") {
            return (new HomeController)->showMotoLanding();
        } else if ($rech == "vélo") {
            return (new HomeController)->showVeloLanding();
        } else {
            return (new HomeController)->landingPage();
        }
    }
    public function showVoitureLanding()
    {
        $annonces_voiture =  array();
        $annonces_moto =  array();
        $annonces_velo =  array();
        ...
        return view('acceuil', compact('annonces_voiture'));
    }
    public function showVeloLanding()
    {
        $annonces_voiture =  array();
        $annonces_moto =  array();
        $annonces_velo =  array();
        ...
        return view('acceuil', compact('annonces_velo'));
    }

    public function showMotoLanding()
    {
        ...
        return view('acceuil', compact('annonces_moto'));
    }
