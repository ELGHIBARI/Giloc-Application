        ...
        elseif ($role == "partenaire") {
            ...
            foreach ($demandes as $demande) {
                ...
                if ($evaluerMonClient->etat == 0 && $date_echeance > date('Y-m-d H:i:s')) {
                    ...
                    $monEvaluation=Evaluation_objet::where([['partenaire_id',Auth::user()->id],['annonce_id',$demande->annonce_id],['client_id',$demande->client_id]])->first();
                    $monObjet=Evaluation_partenaire::where([['partenaire_id',Auth::user()->id],['annonce_id',$demande->annonce_id],['client_id',$demande->client_id]])->first();

                }
                    /*$evalObjet = Evaluation_objet::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);
                    $evalClient = Evaluation_client::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);
                    $evalPartenaire = Evaluation_partenaire::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);*/
            ...
            foreach ($demandes as $demande) {
                $monEvaluation = Evaluation_objet::where([['partenaire_id', Auth::user()->id], ['annonce_id', $demande->annonce_id], ['client_id', $demande->id]])->first();
                $date_echeance = strtotime('+7 days', $monEvaluation->created_at);
                if ($monEvaluation->etat == 0 && $date_echeance > date('Y-m-d H:i:s')) {
                    $evalObjet = Evaluation_objet::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);
                    $evalClient = Evaluation_client::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);
                    $evalPartenaire = Evaluation_partenaire::where([['annonce_id', $demande->annonce_id], ['partenaire_id', Auth::user()->id], ['client_id', $demande->client_id]])->update(['etat' => 2]);
                }
