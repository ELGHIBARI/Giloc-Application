        ...
        elseif ($role == "partenaire") {
            ...
            foreach ($demandes as $demande) {
                if ($demande->date_fin < date('Y-m-d')) {
                    ...
                    $contenuC="Cher client votre durée de location est s'écoulée veuillez nous donner votre feedback à propos du partenaire ainsi que l'objet via le lien suivant : ";
                    $contenuP="Cher partenaire une de vos location a touché sa fin veuillez nous donner votre feedback à propos du client via le lien suivant : ";
