...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($role == "admin") {
            ...
            return view('admin.espaceadmin', ['data' => $data, 'months' => $months, 'monthCount' => $monthCount, 'datad' => $datad, 'monthsd' => $monthsd, 'monthCountd' => $monthCountd, 'datac' => $datac, 'monthsu' => $monthsu, 'monthCountu' => $monthCountu, 'datau' => $datau, 'annonces' => $annonces]);
