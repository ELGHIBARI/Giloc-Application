...
<body>
  ...
  <header class="section-header">
    <nav class="navbar navbar-dark navbar-expand py-0" style="background-color: #2c2b02; background-image: linear-gradient(120deg, #ffb700, #fad4d4); ">
      <div class="container">
        <ul class="navbar-nav d-none d-md-flex mr-auto">
          <li class="nav-item"><a class="nav-link" href="{{ route('home') }}"><img src="{{url('img/logo-80.png')}}" /></a></li>
            ...
            <div class="col-lg-2 col-sm-6 col-12">
              <div class="widgets-wrap float-md-right">
                <div class="widget-header  mr-3">
                  <a href="{{ route('login') }}" class="icon icon-sm rounded-circle border"><i class="fa fa-shopping-cart"></i></a>
                </div>
                <div class="widget-header  mr-3">
                  <a href="{{ route('login') }}" class="icon icon-sm rounded-circle border"><i class="fa fa-envelope"></i></a>
                </div>
              </div>
            </div>
