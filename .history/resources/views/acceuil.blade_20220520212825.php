          ...
          <div class="col-lg-4 col-sm-6 col-12">
            <div class="widgets-wrap float-md-right">
              <div class="widget-header  mr-3">
                ...
                @else {{ route('annonces.show', $annonce['id']) }} @endif" class="icon icon-sm rounded-circle border" data-toggle="dropdown" href="#"><i class="fa fa-shopping-cart"></i>
                    </a>
                  </li>
                </ul>
              </div>
              <div class="widget-header  mr-3">
                <ul class="navbar-nav me-auto">
                  <li class="nav-item">
                    <a href="@if (!Auth::user()) {{ route('login')}}
                @else {{ route('annonces.show', $annonce['id']) }} @endif" class="icon icon-sm rounded-circle border" data-toggle="dropdown" href="#"><i class="fa fa-envelope"></i>
                    </a>
