        ...
        <div class="col-md-3">
          <div href="#" class="card card-product-grid">
            ...
            <figcaption class="info-wrap">
              ...
              @else {{ route('annonces.show', $annonce['id']) }} @endif" class="btn btn-warning ml-5"><i class="fa fa-shopping-cart"></i></a>
                <a href="@if (!Auth::user()) {{ route('login')}} 
              @else {{ route('annonces.show', $annonce['id']) }} @endif" class=class="btn btn-warning ml-1"><i class="fa fa-envelope"></i>
                </a>
                @endif
              </div> <!-- price-wrap.// -->
            </figcaption>
        ...
        <div class="col-md-3">
          <div href="#" class="card card-product-grid">
            ...
            @else  {{ route('login')}}  @endif" class="btn btn-warning ml-5"><i class="fa fa-shopping-cart"></i></a>
                <a href="@if (Auth::user() and Auth::user()->role='client'){route('annonces.show', $annonce['id']) }
            @else  {{ route('login')}}  @endif" class="btn btn-warning ml-1"><i class="fa fa-envelope"></i></a>
                @endif
              </div> <!-- price-wrap.// -->
            </figcaption>
          </div>
