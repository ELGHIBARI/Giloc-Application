...
@section('content')
    ...
    <div id="layoutSidenav_content">
                ...
                <h2 class="pb-2 border-bottom">Espace admin</h2>
                <div class="container">
        ...
        <div class="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
          <svg class="bi cardcolor" width="1em" height="1em"><use xlink:href="#toggles2"></use></svg>
        </div>
        <h2>Les Annoces</h2>
       
        <a href="{{route('annonce')}}" class="icon-link d-inline-flex align-items-center">
        plus d'informations
          <svg class="bi " width="1em" height="1em"><use xlink:href="{{route('annonce')}}"></use></svg>
        </a>
      </div>
                    <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
          <svg class="bi cardcolor" width="1em" height="1em"><use xlink:href="#people-circle"></use></svg>
        </div>
        <h2>Les clients</h2>
        ...
        plus d'informations
          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"></use></svg>
                    ...
                    <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
          <svg class="bi cardcolor" width="1em" height="1em"><use xlink:href="#collection"></use></svg>
        </div>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>   
         ...
         <script>
          ...
          var  _ydatad={!! json_encode($monthsd) !!};


          var   _xdatad={!! json_encode($monthCountd) !!};
          var   _xdatac={!! json_encode($datac) !!};

          var  _ydatau={!! json_encode($monthsu) !!};
          var   _xdatau={!! json_encode($monthCountu) !!};
          var _type={!! json_encode($annonces) !!};
