                                    ...
                                    <div class="card-body">
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane active" id="demande" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-5">Date de début:</strong></div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->date_debut}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Date de fin de location :</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->date_fin}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Prix total de location :</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->prix_total}}</div>
                                                </div>
                                            </div>
