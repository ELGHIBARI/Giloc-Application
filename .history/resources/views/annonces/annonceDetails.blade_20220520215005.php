    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                {{-- <div class="card-header text-right">Demande du client : <strong class="text-red">{{$demande->userDemande->nom_complet}}</strong> pour l'annonce <strong class=" text-red">{{$demande->userAnnonce->titre}}</strong>
            </div> --}}
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="tab-pane" id="annonce" role="tabpanel" aria-labelledby="annonce-tab">
                                            ...
                                            {{-- <div class="row">
                                                    ...
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->premium==1 ? " Premium pour ".$demande->userAnnonce->duree_premium."" : "Normale"}}
                                        </div>
                                    </div> --}}
                                    <div class="row">
                                    ...
                                    {{-- <div class="row">
                                                    ...
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{ $demande->userAnnonce->created_at }}
                                </div>
                            </div> --}}
                        </div>
