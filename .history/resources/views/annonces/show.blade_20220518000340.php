                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    <span style="color:#fc916d; font-size:500"> <h6>{{ $annonce->prix_par_jour }} DH</h6></span>
                        ...
                        <figcaption class="info-wrap m-3">
                            ...
                            <form>
                                ...
                                <div class="d-block mt-3">
                                    ...
                                    <a href="{{ route('annonces.reserver',['id' => $annonce->id, 'id_client' => Auth::user()->id,'date_debut'=>$annonce->date_debut,'date_fin'=>$annonce->date_fin,'prix'=>$annonce->prix_par_jour]) }}" class="btn btn-warning col-md-9 ml-1">Réserver</a>
                                </div>
                            </form> 
                        </figcaption>
                    </div>
