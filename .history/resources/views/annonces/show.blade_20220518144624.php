                        ...
                        <figcaption class="info-wrap m-3">
                            ...
                            <form>
                                ...
                                <div class="d-block mt-3">
                                    ...
                                    <a href="{{ route('annonces.reserver/' . $annonce->id .'/'.Auth::user()->id.'/'.$annonce->date_debut.'/'.$annonce->date_fin.'/'.$annonce->prix_par_jour) }}" class="btn btn-warning col-md-9 ml-1">Réserver</a>
                                </div>
                            </form> 
                        </figcaption>
                    </div>
