    ...
    <section class="section-content">
        <div class="container mt-2">
            ...
            <div class="row mt-2 ml-4 mr-4">
                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <a href="" class="btnConversation" class="btn btn-success d-block" data-bs-toggle="modal" data-bs-target="#ajouterClientModal"><span><i class="fa fa-comments" aria-hidden="true"></i></span> </a>
                                </div>
                            </div>
                        </figcaption>
                    </div>
                ...
                <ul class="list-unstyled activity-wid mb-0 "  style="display:none;">
        ...
        jQuery(document).ready(function($) {
            ...
            $(".btnConversation").click(function() {
                ...
                if ($(".conversation").hasClass('active')) {
                    ...
                    $(".conversation").hide();
                    $(".conversation[data-id!='" + id + "']").show();
                } else {
                    $("#.conversation").show();
                    $(".conversation").addClass('active');
                    $(".conversation[data-id!='" + id + "']").hide();
