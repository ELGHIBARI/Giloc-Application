                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <a href="#" id="btnConversation" class="btn btn-success d-block"><span><i class="fa fa-comments" aria-hidden="true"></i></span> </a>
                                    <a href="#" id="btnAnnonce" class="btn btn-success d-block"><span><i class="fa fa-ads" aria-hidden="true"></i></span> </a>
                                </div>
                            </div>
                        </figcaption>
                    </div>
