                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <div style="display : none;" id="adDiv"><a href="#" id="btnAnnonce" class="btn btn-success d-block"><span><i class="fa-solid fa-megaphone"></i></span>Dtails de l'annonce </a></div>
                                </div>
                            </div>
                        </figcaption>
                    </div>
                    ...
                    <ul class="list-unstyled activity-wid mb-0 ">
                        <div style="overflow-x:auto;">
                            <table class="table mytable">
                                ...
                                <tr>
                                    <td>
                                        <div class="chat" id='messageBody' style="width: 430px; height: 250px; overflow-y: auto;">
