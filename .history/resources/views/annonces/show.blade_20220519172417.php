    ...
    <section class="section-content">
        <div class="container mt-2">
            ...
            <div class="row mt-2 ml-4 mr-4">
                ...
                <div class="col-md-6" style="display:none" id="conversation">
                    <ul class="list-unstyled activity-wid mb-0 ">
                        <div style="overflow-x:auto;">
                            <table class="table mytable">
                                ...
                                <tr>
                                    <td>
                                        <div class="chat" id='messageBody' style="width: 500px; height: 250px; overflow-y: auto;">
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#btnConversation").click(function() {
                ...
                $("#cnvDiv").hide();
                $("#adDiv").show();
                $('#messageBody').scrollTop($('#messageBody' + id)[0].scrollHeight);
