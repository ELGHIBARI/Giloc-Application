                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <div id="cnvDiv"><a href="#" id="btnConversation" class="btn btn-success d-block"><span><i class="fa fa-comments" aria-hidden="true"></i></span> </a></div>
                                    <div style="display : none;" id="adDiv"><a href="#" id="btnAnnonce" class="btn btn-success"><span>Détails</span></a></div>
                                </div>
                            </div>
                        </figcaption>
                    </div>
