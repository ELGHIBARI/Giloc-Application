...
<body>
    ...
    <section class="section-content">
        <div class="container mt-2">
                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <a href="#" id="#cnvDiv" class="btn btn-success d-block"  data-bs-target="#ajouterClientModal"><span><i class="fa fa-comments" aria-hidden="true"></i></span> </a>
                                    <a href="#" id="#adDiv" class="btn btn-success d-block" ><span></i></span>Détails</a>
                                </div>
                            </div>
                        </figcaption>
                    </div>
            ...
            <div class="col-md-5" style="display:none" id="conversationMoto">
                <ul class="list-unstyled activity-wid mb-0 ">
                    <div style="overflow-x:auto;">
                        <table class="table mytable">
                            <thead class="clickable-row" data-id="{{$conversation->id}}" data-receiver="{{$conversation->partenaire_id}}" style="background-color:cornsilk">
                            ...
                            <tr>
                                <td>
                                    <div class="chat" id='messageBodyMoto' style="width: 420px; height: 250px; overflow-y: auto;">
                                        <div class="chat-history bg-light">
                                            <ul class="m-b-0">
                                                @foreach($conversation->messages as $messages)
                                                @php $id_receiver=$messages->receiver_id; @endphp
        ...
        jQuery(document).ready(function($) {
            ...
            $(".btnConversation").click(function() {
                ...
                $(document).on('click', '.envoyer', function() {
                    alert("id " + id + "rceiver" + id_receiver);
                    var msg = $(".msg").val();
                    $(".msg").val('');
