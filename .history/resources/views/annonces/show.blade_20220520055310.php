                        ...
                        <figcaption class="info-wrap">
                            <div class="row m-1">
                                ...
                                <div class="col-md-2 m-l-2">
                                    ...
                                    <div ><a href="#"  id="#cnvDiv" class="btn btn-success d-block" data-bs-target="#ajouterClientModal"><span><i class="fa fa-comments" aria-hidden="true"></i></span> </a></div>
                                    <div  style="display:none;"><a href="#" id="#adDiv"  class="btn btn-success d-block"><span></i></span>Détails</a></div>
                                </div>
                            </div>
                        </figcaption>
                    </div>
