                        ...
                        <figcaption class="info-wrap m-3">
                            ...
                            <form>
                                ...
                                <div class="d-block mt-3">
                                    ...
                                    <a href="{{ route('annonces.reserver',['id' => $annonce->id, 'id_client' => Auth::user()->id,'vehicule'=>$vehicules[0]->marque,'modele'=>$vehicules[0]->modele,'date_debut'=>$annonce->date_debut,'date_fin'=>$annonce->date_fin,'prix'=>$annonce->prix_par_jour]) }}" class="btn btn-warning col-md-9 ml-1" <?php if($annonce->etat=="en location") echo 'disabled';?>>Réserver</a>
                                </div>
                            </form>
                        </figcaption>
                    </div>
