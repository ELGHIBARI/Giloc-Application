...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right headregister">{{ __('Inscription') }}</div>
                <div class="card-header text-right headregister"><img src="{{ asset('img/logo (2).png') }}" alt="giloc"></div>
                <div class="card-body">
