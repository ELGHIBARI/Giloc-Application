            ...
            <div class="widget-header  mr-3">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item text-right" onclick="document.write('<?php $notification->markAsRead(); ?>');">
                  <small><strong>votre demande pour l'annonce </strong><br /> {{$notification->data['titre_annonce']}} a été refusé<br /><small><span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
