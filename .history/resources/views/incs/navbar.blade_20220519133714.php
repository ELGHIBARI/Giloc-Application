            ...
            <div class="widget-header  mr-3">
              <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link icon icon-sm rounded-circle border" data-toggle="dropdown" href="{{ route('client.demande') }}" style="padding-bottom: 10%;"><i class="fa fa-shopping-cart"></i>
