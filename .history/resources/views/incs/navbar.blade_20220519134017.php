            ...
            <div class="widget-header  mr-3">
              <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link icon icon-sm rounded-circle border" data-toggle="dropdown" href="#"><i class="fa fa-shopping-cart" onclick="document.write('<?php $notification->markAsRead(); ?>');"></i>
                  ...
                  <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="{{ route('client.demande') }}" class="dropdown-item text-left">
