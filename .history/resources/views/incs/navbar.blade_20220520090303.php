              ...
              <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    @php $notifications=Auth::user()->unreadNotifications->where('type','App\Notifications\RefusDemandeNotification')
                                                                         ->orWhere('type','App\Notifications\AcceptNotification');
                     @endphp
                    ...
                    <a href="{{ route('client.demande') }}" class="dropdown-item text-left" onclick="document.write('<?php $notification->markAsRead(); ?>');">
                      <small><strong>Demande pour l'annonce</strong><br /> {{$notification->data['titre_annonce']}}<br /></small> <small><span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date']);
