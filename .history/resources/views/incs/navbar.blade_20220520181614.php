<header class="section-header">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"><div class="icon icon-xs rounded-circle border"><i class="fa fa-user"></i></div>
  ...
  <nav class="navbar navbar-main navbar-expand-lg navbar-light border-bottom" style="background-color: #f4f7f6;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="main_nav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link pl-0" href="{{ url('/home') }}"><strong> <i class="fa fa-bars"></i> Tous </strong></a>
          </li>
          <li class="nav-item">
