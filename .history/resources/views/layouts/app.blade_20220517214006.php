                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                <i class="fas fa-envelope mr-2"></i> $notification['demande']
                                <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($demande->created_at);
                                    $difference = time()-$date_envoi_dem;@andphp
                                    @if($difference<=24)$hour=abs(round($difference / 3600)) $minutes=$difference-$hour $minutes=abs($minutes)*60 {{$hours}}heures{{ $minutes}} minutes @else {{ abs(round($difference / 86400)) }} jours  @if </a>
                                        <div class="dropdown-divider"></div>
