                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($demande->created_at);
                                    ...
                                    @if($difference<=24)$hour=abs(round($difference / 3600)) $minutes=$difference-$hour $minutes=abs($minutes)*60 {{$hours}}heures{{ $minutes}} minutes @else {{ abs(round($difference / 86400)) }} jours  @endif </a>
                                        <div class="dropdown-divider"></div>
