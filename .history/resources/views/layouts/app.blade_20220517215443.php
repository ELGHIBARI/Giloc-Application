                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification['date_demande']);
                                    $difference = time()-$date_envoi_dem; @dd($difference); @dd($date_envoi_dem) @endphp
                                    @if($difference<=86400)$hours=abs(round($difference / 3600)) $minutes=$difference-$hour $minutes=abs($minutes)*60 {{$hours}}heures{{ $minutes}} minutes @else {{ abs(round($difference / 86400)) }} jours @endif </a>
                                </span>
                            </a>
                            @endforeach
                            <div class="dropdown-divider"></div>
