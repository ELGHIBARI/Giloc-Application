                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
                                    ...
                                    @if($difference<=86400)@php $hours=abs(round($difference / 3600)); $minutes=$difference-$hours; $minutes=abs(floor($minutes))/60; @endphp {{$hours}}heures{{ $minutes}} minutes @else {{ abs(round($difference / 86400)) }} jours @endif $notification->data['titre_annonce']  pour le client $notification->data['client'] </a>
                                </span>
                            </a>
                            @endforeach
                            <div class="dropdown-divider"></div>
