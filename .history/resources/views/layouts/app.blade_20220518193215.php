                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                <i class="fa-solid fa-list"></i> <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
                                    $difference = time()-$date_envoi_dem; @endphp
                                    @if($difference
                                    <=86400)@php $hours=abs(round($difference / 3600)); $minutes=$difference-$hours; $minutes=abs(floor($minutes))/60; @endphp {{$hours}} heures{{ $minutes}} minutes @else {{ abs(round($difference / 86400)) }} jours @endif <br /> Demande pour l'annonce : {{$notification->data['titre_annonce']}}<br> Client interssé : {{$notification->data['client']}} </a>
                            </span>
                            </a>
                            @endforeach
                            <div class="dropdown-divider"></div>
