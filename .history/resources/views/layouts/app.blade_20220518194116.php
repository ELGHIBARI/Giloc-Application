                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item">
                                <i class="fa-solid fa-list mr-3"></i><small>Demande pour l'annonce :<br/> {{$notification->data['titre_annonce']}}<br/> Client interssé : {{$notification->data['client']}}</small> <span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
