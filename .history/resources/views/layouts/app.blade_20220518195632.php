                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="#" class="dropdown-item text-right">
                                <small><strong>Demande pour l'annonce</strong><br /> {{$notification->data['titre_annonce']}}<br /><strong> Client interssé</strong> {{$notification->data['client']}}<br /></small> <small><span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
