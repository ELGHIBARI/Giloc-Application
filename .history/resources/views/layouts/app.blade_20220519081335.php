                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            @php $id_demande=$notification->data['id_demande']; $id_client=$notification->data['id_client'];@endphp
                            <a href="{{ url('/demande/details/'.$id_client.'/'.$id_demande) }}" class="dropdown-item text-right">
                                <small><strong>Demande pour l'annonce</strong><br /> {{$notification->data['titre_annonce']}}<br /><strong> Client interssé</strong> <br>{{$notification->data['client']}}<br /></small> <small><span class="float-right text-muted text-sm"> @php $date_envoi_dem = strtotime($notification->data['date_demande']);
                                        ...
                                        @if($difference
                                        <=86400)@php $hours=abs(ceil($difference / 3600)); $minutes=$difference-$hours; $minutes=ceil($minutes/60); @endphp {{$hours}} heures{{ $minutes}} minutes @else {{ abs(ceil($difference / 86400)) }} jours @endif </a>
                                    </span></small>
                            </a>
                            @endforeach
                            <div class="dropdown-divider"></div>
