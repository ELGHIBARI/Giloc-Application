                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <span class="dropdown-item dropdown-header">{{Auth::user()->unreadNotifications->where('type','App\Notifications\DemandeNotification')->count() + Auth::user()->unreadNotifications->where('type','App\Notifications\AcceptNotification')->count()}} Notifications</span>
