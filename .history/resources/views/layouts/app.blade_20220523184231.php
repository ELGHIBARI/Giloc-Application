...
<body>
    <div>
        <nav class="navbar navbar-expand-md navbar-light navcolor shadow-sm py-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li>
                        <a class="nav-link" href="{{ url('/evaluations/'.$id) }}">Evaluations</a>
                    </li>
                    @endif
                    @endauth
                </ul>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item text-right" href="{{ route('profile') }}" onclick="event.preventDefault();
