                    ...
                    <li class="nav-item dropdown"><a href="#" class="nav-link">
                            <div class="widget-header icontext ">
                                ...
                                <div class="text">
                                    <span>
                                        @if (Auth::user())
                                        <span> <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>{{ Auth::user()->nom_complet }}</a></span>
                                        @else
                                        <a href="">Sign in</a> |
                                        <a href=""> Register</a>
                                        @endif
