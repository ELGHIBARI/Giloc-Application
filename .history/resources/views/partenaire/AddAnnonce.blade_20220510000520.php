                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6"  id='marque'>
                                                <label for="marque">Marque</label>
                                                <input type='text' class='form-control' name='marque' />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6" id='modele'>
                                                <label for="modele">Modèle</label>
                                                <input type='text' class='form-control' name='modele' />
                                            </div>
                                            <div class="col-md-6"  id='modelAnnee'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6"  id='puissance'>
