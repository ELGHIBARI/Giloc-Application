                        ...
                        <div class="col-md-12 mx-0">
                            <form method="POST" action="{{url('annonce/store')}}" id="msform" enctype="multipart/form-data">
                                ...
                                <fieldset class="panels">
                                    <div class="form-card">
                                        ...
                                        <div class="row mb-4 ">
                                            <div class="col-md-6">
                                                ...
                                                <select id="vehicule" class="form-control" name="typeVehicule" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='marque'>
                                                ...
                                                <input id="test" type='text' class='form-control' name='marque' required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='modeleAnnee'>
                                                ...
                                                <input type='text' class='form-control' name='modelAnnee' required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='puissance'>
                                                ...
                                                <input type='text' class='form-control' name='puissance'required />
                                            </div>
                                   ...
                                   <!-- <button name="next" class="next action-button" class="next-q" >Suivant</button> -->
                                    <button name="next" class="next action-button" disabled>Suivant</button>
...
$panelsInput.click(function () {
  if ($(this).closest('.panels').find('input:checked').length >= 0) {
    $(this).closest('.panels').find('.next action-button').prop('disabled', false);
  }
  else {
    $(this).closest('.panels').find('.next action-button').prop('disabled', true);
  }
});
