                        ...
                        <div class="col-md-12 mx-0">
                            <form method="POST" action="{{url('annonce/store')}}" id="msform" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='marque'>
                                                ...
                                                <input id="inMarque" type='text' class='form-control' name='marque' required/>
                                            </div>
                                            <div class="col-md-6" style='display:none;' id='modele'>
                                                <label for="modele">Modèle</label>
                                                <input id="inModele" type='text' class='form-control' name='modele' required />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='modeleAnnee'>
                                                ...
                                                <input id="inAnnee" type='number' class='form-control' min="1900" max="{{ now()->year }}" name='modelAnnee' required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='puissance'>
                                                ...
                                                <input id="inPF" type='text' class='form-control' name='puissance'required />
                                            </div>
                                            <div class="col-md-6" style='display:none;' id="nbrplace">
                                                <label for="nbr">Nombre de place</label>
                                                <select class="form-control" name="nbrplace" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='marqueMoto'>
                                                ...
                                                <input id="inMarMoto" type='text' class='form-control' name='marqueMoto' required/>
                                            </div>
                                            <div class="col-md-6" style='display:none;' id='modeleMoto'>
                                                <label for="modeleMoto">Modèle</label>
                                                <input id="inModMoto" type='text' class='form-control' name='modeleMoto'required />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='anneeMoto'>
                                                <label for="anneeMoto">Année du modèle</label>
                                                <input id="inAnneeMoto" type='text' class='form-control' name='anneeMoto' required/>
                                            </div>
                                            <div class="col-md-6" style='display:none;' id='cylindreeMoto'>
                                                <label for="cylindreeMoto">Cylindrée</label>
                                                <input id="incyl"type='text' class='form-control' name='cylindreeMoto' required/>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <input type="button" name="next" id="nex1" class="next action-button" value="suivant" />
...
<script>
    ...
    var form = $('#msform').serialize();
        ...
        var modele_voiture = $('#inMarque').val();
        var annee_voiture = $('#inMarque').val();
        var puissance_voiture = $('#inMarque').val();
        if(marque_voiture.length==0){
            alert("entrer la marque de voiture")
