                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <input id="inTitre" type='text' class='form-control' name='titre' />
                                        </div>
                                        <div class="row">
                                            <label for="prix">Images pour l'objet</label>

                                            <input id="inimages" type="file" name="images[]" value="" multiple />
                                        </div>
                                        <div class="row">
                                            <label for="date">Description de l'annonce</label>
                                            <textarea id="indescription" class='form-control' name='description'></textarea>
                                        </div>

                                    </div>
                                    <input type="button" name="previous" class="previous action-button-previous" value="précédent" />
                                    <input type="submit" name="make_payment" id="next3" class="next action-button" value="Confirmer" />
                                </fieldset>
                            </form>
                        </div>
                    </div>
