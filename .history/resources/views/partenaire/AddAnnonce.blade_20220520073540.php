                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type='date' id="indate" class='form-control' min ="{{ date('Y-m-d') }}" name='date_debut' />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="date">Date fin</label>
                                                <input type='date' id="findate" class='form-control' min ="{{ date('Y-m-d') }}" name='date_fin' />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
...
<script>
    ...
    $('#next2').click(function() {
        ...
        var prix = $('#inprix').val();
        var date = $('#indate').val();
        var datef = $('#findate').val();
        if (date.length == 0 || datef.length == 0) {
        ...
        // V E R I F I E R L E S D A T E S 
        if(date >= datef) {
            alert("Date fin doit etre supérieur à date début !!");
            document.getElementById("nex2").disabled = true;
        }
    });
