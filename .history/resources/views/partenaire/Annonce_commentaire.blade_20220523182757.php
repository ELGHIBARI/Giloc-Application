...
<div class="row">
    <div class="col-md-4">
        <div class="col-xl-12 ml-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="header-title mb-4 text-right">Commentaires Positifs </h5>
                    @if($rating!=null)
                    ...
                    @endforeach
                    @endif
                    <h5 class="header-title mb-4 text-right">Commentaires negatifs </h5>
                    @if($rating!=null)
                    @foreach($rating as $rate)
    ...
    <div class="col-md-8 ">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="card-title text-right d-block w-75">
                            <h4>{{$annonces_voiture[0]['titre']}}</h4>
                        </div>
                        @php
                        $style=($annonces_voiture[0]['etat']=='activee'||$annonces_voiture[0]['etat']=='en attente'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color:lightyellow;":"");
                        $style1=($annonces_voiture[0]['etat']=='archivee' ||$annonces_voiture[0]['etat']=='en attente'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color:lightyellow;":"");
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/active/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary mb-1" <?php echo 'style="' . $style1 . '"' ?>>Activer</a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 text-right col-sm-6">
                            ...
                            <h4 class="box-title mt-1">Les details de l'annonce</h4>
                            ...
                            <h4 class="box-title mt-1">Les details de vehicule </h4>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/active/moto/'.$annonces_moto[0]['id'])}}" class="btn btn-primary mb-1" <?php echo 'style="' . $style1 . '"' ?>>Activer</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="card-title text-right d-block w-75">
                            <h4>{{$annonces_velo[0]['titre']}}</h4>
                        </div>
                        @php
                        $style=($annonces_velo[0]['etat']=='activee'||$annonces_velo[0]['etat']=='en attente'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color:lightyellow;":"");
                        $style1=($annonces_velo[0]['etat']=='archivee' ||$annonces_velo[0]['etat']=='en attente'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color:lightyellow;":"");
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/active/velo/'.$annonces_velo[0]['id'])}}" class="btn btn-primary mb-1" <?php echo 'style="' . $style1 . '"' ?>>Activer</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
