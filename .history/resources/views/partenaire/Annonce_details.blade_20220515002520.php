        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="clickable-row hover-overlay hover-zoom hover-shadow ripple">
                    <ul class="list-unstyled activity-wid mb-0 clickable-row hover-overlay hover-zoom hover-shadow ripple">
