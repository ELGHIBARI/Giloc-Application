            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled activity-wid mb-0 ">
                        ...
                        <table>
                            <tr class="clickable-row" data-id="cnv{{$conversation->id}}">
                                <td>
                                    <li class="activity-list activity-border">
                                        <div class="activity-icon avatar-sm">
                                            <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="avatar-sm rounded-circle" alt="">
                            ...
                            <tr class="table table-hover" id="showConversationcnv{{$conversation->id}}" style="display:none">
                                <td>
                                    @foreach($conversation->messages as $messages)
                                    @if($messages->sender_id==Auth::user()->id)
                                    <div class="text-right">{{$messages->contenu}}</div>
                                    @else
                                    <div class="text-left">{{$messages->contenu}}</div>
                                    @endif
                                    @endforeach
                                </td>
                            </tr>
