                                        ...
                                        <ul class="m-b-0">
                                            ...
                                            <li class="clearfix">
                                                <div class="message-data">
                                                    <span class="message-data-time">{{$messages->created_at->format('H:i:s')}}, le {{$messages->created_at->format('yyyy:mm:dd')}} </span>
                                            ...
                                            <li class="clearfix">
                                                <div class="message-data text-right">
                                                    <span class="message-data-time">{{$messages->created_at->format('H:i:s')}}, Today</span>
                                                    <div class="message other-message float-right">{{$messages->contenu}}</div>
                                                </div>
                                            </li>
                                            @endif
                                            @endforeach
