                                    ...
                                    <div class="chat" style="overflow: auto;">
                                        <div class="chat-history">
                                            <ul class="m-b-0">
                                                ...
                                                @php $id_receiver=$messages->receiver_id; @php
                                                ...
                                                <li class="clearfix">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="message other-message text-right">{{$messages->contenu}}</div>
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                ...
                                                <a href="#" data-id="{{$id_receiver}}" id="#envoyer" class="btn btn-success">envoyer</i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    ('#envoyer').click(function() {
            ...
            $.ajax({
                url: 'message/{id_conversation}/{id_receiver}',
                type: 'GET',
                data: { id: id , id_receiver : id_receiver, msg : msg },
