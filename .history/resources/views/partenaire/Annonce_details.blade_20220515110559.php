                                    ...
                                    <div class="chat" style="overflow: auto;">
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                ...
                                                <a href="#" data-id="{{$id_receiver}}" id="envoyer" class="btn btn-success">envoyer</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('#envoyer').click(function() {
            ...
            $.ajax({
                url: 'message/{id_conversation}/{id_receiver}/{msg}',
                type: 'GET',
                data: { id_conversation: id_conversation , id_receiver : id_receiver, msg : msg },
