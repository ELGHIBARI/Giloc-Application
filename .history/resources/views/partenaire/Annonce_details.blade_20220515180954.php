                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled activity-wid mb-0 ">
                        ...
                        <table class="table mytable">
                            <thead class="clickable-row" data-id="{{$conversation->id}}" data-receiver="{{$conversation->client_id}}">
                                <td>
                                    <li class="activity-list activity-border">
                                        <div class="activity-icon avatar-sm">
                                            <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="avatar-sm rounded-circle" alt="">
                            ...
                            <tr id="showConversation{{$conversation->id}}" style="display:none;">
                                <td>
                                    <div class="chat" id='messageBody' style="width: 400px; height: 250px; overflow-y: scroll; ">
                                    ...
                                    <div class="chat-message clearfix mt-3">
                                        <div class="input-group mb-0">
                                            <div class="input-group-prepend">
                                                ...
                                                <button type="button" class="btn btn-primary" id="envoyer{{$conversation->id}}">envoyer</button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $(".clickable-row").click(function() {
            ...
            alert('conversation clique '+id +'id recepteur '+id_receiver);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $(".inner").append('<div class="row">' +
                        ...
                        '<div class="col-12 float-right">' +
                        '<div class="message-data">' +
                        '<small class="message-data-time">' + +'</small>' +
                        '</div>' +
                        '</div>' +
                        ' </div>' +
                        '</div>' +
