...
<style>
    .mytable thead:hover {
      ...
      background-color: #2c2b02; background-image: linear-gradient(120deg, #fad4d4, #ffb700);
    }
</style>
@endsection
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled activity-wid mb-0 ">
                        ...
                        <table class="table mytable">
                            <thead class="clickable-row" data-id="{{$conversation->id}}" data-receiver="{{$conversation->client_id}}" style="background-color: #2c2b02; background-image: linear-gradient(120deg, #fad4d4, #ffb700);">
                                <td>
                                    <li class="activity-list activity-border">
                                        <div class="activity-icon avatar-sm">
                                            <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="avatar-sm rounded-circle" alt="">
                            ...
                            <tr id="showConversation{{$conversation->id}}" style="display:none;">
                                <td>
                                    <div class="chat" id='messageBody{{$conversation->id}}' style="width: 400px; height: 250px; overflow-y: auto;">
                                    ...
                                    <div class="chat-message clearfix mt-3">
                                        <div class="input-group mb-0">
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="button" class="btn btn-primary" id="envoyer{{$conversation->id}}" value="envoyer">
                                            </div>
                                        </div>
                                </td>
                            </tr>
