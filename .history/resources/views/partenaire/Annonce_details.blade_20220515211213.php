                            ...
                            <table class="table mytable">
                                ...
                                <tr id="showConversation{{$conversation->id}}" style="display:none;">
                                    <td>
                                        ...
                                        <div class="chat-message clearfix mt-3 mx-auto">
                                            <div class="input-group mb-0">
                                                <div class="input-group-prepend">
                                                    <input type="text" class="form-control" id="msg{{$conversation->id}}" placeholder="Enter text here...">
                                                    <h5 style="color : #ffb700;"><a class="btn btn-primary" id="envoyer{{$conversation->id}}"><i class="fa-regular fa-paper-plane"></i></a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
