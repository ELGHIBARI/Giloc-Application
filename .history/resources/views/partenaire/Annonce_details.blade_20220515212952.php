                        ...
                        <div style="overflow-x:auto;">
                            <table class="table mytable">
                                ...
                                <tr id="showConversation{{$conversation->id}}" style="display:none;">
                                    <td>
                                        <div class="chat" id='messageBody{{$conversation->id}}' style="width: 500px; height: 250px; overflow-y: auto;">
                                        ...
                                        <div class="chat-message clearfix mt-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span><a class="btn btn-primary" id="envoyer{{$conversation->id}}"><h4 style="color :white"><i class="fa-regular fa-paper-plane"></i></h4></a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
