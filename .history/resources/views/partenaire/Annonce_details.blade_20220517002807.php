                        ...
                        <a href="" style="color:black ; text-decoration: none;">
                            <li class="activity-list activity-border">
                                ...
                                <div class="media">
                                    <div class="me-3">
                                        @foreach($client as $c)
                                        <h5 class="font-size-15 mb-1">{{$c->nom_complet}}</h5>
                                        <h6 class="font-size-15 mb-1">{{$c->ville}}</h6>
                                        @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @php
                        $style=($annonces_voiture[0]['etat']=='activee'||$annonces_voiture[0]['etat']=='en attend'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        $style1=($annonces_voiture[0]['etat']=='archivee' ||$annonces_voiture[0]['etat']=='en attend'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/archive/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary  mb-1">Archiver </a>
                            <a href="{{url('/annonce/active/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary mb-1">Activer</a>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @php
                        $style=($annonces_moto[0]['etat']=='activee'||$annonces_moto[0]['etat']=='en attend'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        $style1=($annonces_moto[0]['etat']=='archivee' ||$annonces_moto[0]['etat']=='en attend'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/archive/moto/'.$annonces_moto[0]['id'])}}" class="btn btn-primary  mb-1">Archiver </a>
                            <a href="{{url('/annonce/active/moto/'.$annonces_moto[0]['id'])}}" class="btn btn-primary mb-1">Activer</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @php
                        $style=($annonces_velo[0]['etat']=='activee'||$annonces_velo[0]['etat']=='en attend'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        $style1=($annonces_velo[0]['etat']=='archivee' ||$annonces_velo[0]['etat']=='en attend'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color: gray;":"");
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/archive/velo/'.$annonces_velo[0]['id'])}}" class="btn btn-primary  mb-1">Archiver </a>
                            <a href="{{url('/annonce/active/velo/'.$annonces_velo[0]['id'])}}" class="btn btn-primary mb-1">Activer</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.clickable-row', function() {
            ...
            alert(id1);
            var id_receiver1 = $(this).data("receiver");
            $("#id_conversation").val(id1);
            $("#id_receiver").val(id_receiver1);

            if ($(".clickable-row").hasClass('active')) {
                $(".clickable-row").removeClass('active')
                $("#showConversation" + id).hide();
                $(".clickable-row[data-id!='" + id1 + "']").show();
            } else {
                $("#showConversation" + id1).show();
                $(".clickable-row").addClass('active');
                $(".clickable-row[data-id!='" + id1 + "']").hide();
                $('#messageBody' + id1).scrollTop($('#messageBody' + id)[0].scrollHeight);
            }
        });
        $("#envoyer" + id1).click(function(event) {
            event.preventDefault();
            let id = $("#id_conversation").val();
            let id_receiver = $("#id_receiver").val();
            let msg = $("#msg" + id).val();
