                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="d-block float-right w-25 ">
                            ...
                            <a href="{{url('/annonce/archive/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary  mb-1" style="{{$style}}">Archiver </a>
                            <a href="{{url('/annonce/active/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary mb-1" style="{{$style1}}">Activer</a>
                        </div>
                    </div>
                    <div class="row">
