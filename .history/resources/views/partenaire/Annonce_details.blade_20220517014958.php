            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @php
                        $style=($annonces_voiture[0]['etat']=='activee'||$annonces_voiture[0]['etat']=='en attend'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: lightgray;":"");
                        $style1=($annonces_voiture[0]['etat']=='archivee' ||$annonces_voiture[0]['etat']=='en attend'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: lightgray;":"");
