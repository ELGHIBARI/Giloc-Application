                            ...
                            <li class="activity-list activity-border">
                                ...
                                <div class="media">
                                    <div class="me-3">
                                        ...
                                        <h5 class="font-size-15 mb-1">{{$demande->userDemande->nom_complet}}</h5>
                                        <h6 class="font-size-15 mb-1">{{$demande->userDemande->ville}}</h6>
                                    </div>

                                    <div class="media-body">
                                        <div class="text-end d-none d-md-block">
                                            <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i class="fa fa-calendar font-size-15 text-primary"></i>
                                                @php $date_envoi_dem = strtotime($ticket->created_at);
                                                     $difference = $date_envoi_dem - time();
                                                 @endphp
                                                {{$difference}}
                                            </p>
                                        </div>
