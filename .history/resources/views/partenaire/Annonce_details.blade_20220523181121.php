            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @php
                        $style=($annonces_moto[0]['etat']=='activee'||$annonces_moto[0]['etat']=='en attente'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow;":"");
                        $style1=($annonces_moto[0]['etat']=='archivee' ||$annonces_moto[0]['etat']=='en attente'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow;":"");
