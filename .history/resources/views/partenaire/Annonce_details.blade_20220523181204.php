...
<div class="row">
    <div class="col-md-5">
        <div class="col-xl-12 mr-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="header-title mb-4 text-right">Demandes </h5>
                    @if($demandes!=null)
                    @foreach($demandes as $demande)
                    <ul class="list-unstyled activity-wid mb-0">
                        <a href="{{ url('demande/details/'.$demande->id.'/'.$demande->client_id .'/'.$demande->id) }}" style="color:black ; text-decoration: none;">
                            <li class="activity-list activity-border">
                                ...
                                <div class="media">
                                    <div class="me-3">
                                        <h5 class="font-size-15 mb-1 text-right">{{$demande->userDemande->nom_complet}}</h5>
                                        <p class="text-muted font-size-14 mb-0 text-right">{{$demande->userDemande->ville}}</p>
                                    </div>
                    ...
                    @endif
                    <h5 class="header-title mb-4 text-right">Messages </h5>
                    <ul class="list-unstyled activity-wid mb-0 ">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="card-title text-right d-block w-75 pr-2">
                            <h5>{{$annonces_voiture[0]['titre']}}</h5>
                        </div>
                        @php
                        $style=($annonces_voiture[0]['etat']=='activee'||$annonces_voiture[0]['etat']=='en attente'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow; border-color:lightyellow;":"");
                        $style1=($annonces_voiture[0]['etat']=='archivee' ||$annonces_voiture[0]['etat']=='en attente'||$annonces_voiture[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow;border-color:lightyellow;":"");
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{url('/annonce/evaluation/voiture/'.$annonces_voiture[0]['id'])}}" class="btn btn-primary  mb-1">Voir les commentaires </a>
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                            <h5 class="box-title mt-0 text-right">Description</h5>
                            ...
                            <h5 class="box-title mt-1">Les details de l'annonce</h5>
                            <ul class="list-unstyled w-100">
                                <li><i class="fa fa-check text-success pl-3"></i>type : {{$annonces_voiture[0]['type_vehicule']}} </li>
                                <li><i class="fa fa-check text-success pl-3"></i>Date de début : {{$annonces_voiture[0]['date_debut']}} </li>
                                <li><i class="fa fa-check text-success pl-3"></i>Date de fin : {{$annonces_voiture[0]['date_fin']}} </li>
                            ...
                            <h5 class="box-title mt-1">Les details de vehicule </h5>
    ...
    <div class="col-md-7 ">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="card-title d-block text-right w-75 pr-2">
                            <h5>{{$annonces_moto[0]['titre']}}</h5>
                        </div>
                        @php
                        $style=($annonces_moto[0]['etat']=='activee'||$annonces_moto[0]['etat']=='en attente'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow; border-color:lightyellow;":"");
                        $style1=($annonces_moto[0]['etat']=='archivee' ||$annonces_moto[0]['etat']=='en attente'||$annonces_moto[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow; border-color:lightyellow;":"");
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{url('/annonce/evaluation/moto/'.$annonces_moto[0]['id'])}}" class="btn btn-primary  mb-1">Voir les commentaires </a>
                            </div>

                        </div>

                        <div class="col-lg-6 col-md-6 text-right col-sm-6">
                            <h5 class="box-title mt-0">Description</h5>
                            ...
                            <ul class="list-unstyled  w-100">
                                ...
                                <li><i class="fa fa-check text-success pl-3"></i>Date de Début : {{$annonces_moto[0]['date_debut']}} </li>
                                <li><i class="fa fa-check text-success pl-3"></i>Date de Fin : {{$annonces_moto[0]['date_fin']}} </li>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="card-title d-block w-75 text-right pr-2">
                            <h5>{{$annonces_velo[0]['titre']}}</h5>
                        </div>
                        @php
                        $style=($annonces_velo[0]['etat']=='activee'||$annonces_velo[0]['etat']=='en attente'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow; border-color:lightyellow;":"");
                        $style1=($annonces_velo[0]['etat']=='archivee' ||$annonces_velo[0]['etat']=='en attente'||$annonces_velo[0]['etat']=='en location' ? "pointer-events: none;background-color: lightyellow;border-color:lightyellow;":"");
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6  ">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{url('/annonce/evaluation/velo/'.$annonces_velo[0]['id'])}}" class="btn btn-primary  mb-1">Voir les commentaires </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                            ...
                            <ul class="list-unstyled w-100">
                                ...
                                <li><i class="fa fa-check text-success pl-3"></i>Date de début : {{$annonces_velo[0]['date_debut']}} </li>
                                <li><i class="fa fa-check text-success pl-3"></i>Date de fin : {{$annonces_velo[0]['date_fin']}} </li>
