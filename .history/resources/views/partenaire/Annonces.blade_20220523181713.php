    ...
    <div class="col-sm-4 ">
      <div class="card w-100">
        ...
        <div class="card-body pt-0 px-0">
          ...
          <div class="d-flex flex-row justify-content-between mt-3 px-3">
            <h5>Prix</h5>
            <h5>{{$annonce['prix_par_jour']}} MAD</h5>
          </div>
          <hr class="mt-2 mx-3">
          <div class="d-flex flex-row justify-content-between px-3 pb-4">
            <div class="d-flex flex-column"><span class="text-muted text-right">à partir de <strong>{{$annonce['date_debut']}}</strong> jusqu'à <strong>{{$annonce['date_fin']}}</strong> </span></div>
          </div>
          <div class="d-flex flex-row justify-content-between px-3 pb-4">
    ...
    <div class="col-sm-4 ">
      <div class="card w-100">
        ...
        <div class="card-body pt-0 px-0">
          ...
          <hr class="mt-2 mx-3">
          <div class="d-flex flex-row justify-content-between px-3 pb-4">
            <div class="d-flex flex-column"><span class="text-muted">à partir {{$annonce['date_debut']}} Desponible jusqu'a</span></div>
            <div class="d-flex flex-column">
