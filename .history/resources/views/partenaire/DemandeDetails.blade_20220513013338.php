                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#description" role="tab" aria-controls="demande" aria-selected="true">Détails de la demande</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#history" role="tab" aria-controls="annonce" aria-selected="false">Détails de l'annonce</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#deals" role="tab" aria-controls="vehicule" aria-selected="false">Détails de véhicule</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane" id="annonce" role="tabpanel" aria-labelledby="history-tab">
                                    ...
                                    <div class="tab-pane" id="vehicule" role="tabpanel" aria-labelledby="deals-tab">
