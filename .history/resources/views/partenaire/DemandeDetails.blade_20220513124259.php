                                ...
                                <div class="card">
                                    <div class="card-header gradInverse">
                                        <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active btn btn-primary" href="#demande" role="tab" aria-controls="demande" aria-selected="true">Détails de la demande</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link btn-primary" href="#annonce" role="tab" aria-controls="annonce" aria-selected="false">Détails de l'annonce</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link btn-primary" href="#vehicule" role="tab" aria-controls="vehicule" aria-selected="false">Détails de véhicule</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
