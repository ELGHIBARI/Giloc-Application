    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header text-right" style="border: 0px solid ; background-color :white;">Demande du client : {{$demande->userDemande->nom_complet}} pour l'annonce {{$annonce->titre}}</div>
