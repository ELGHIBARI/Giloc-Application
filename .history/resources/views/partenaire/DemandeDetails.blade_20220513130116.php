    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header text-right" style="border: 0px solid ; background-color :white; color : bc3906;">Demande du client : <strong>{{$demande->userDemande->nom_complet}}</strong> pour l'annonce <strong>{{$annonce->titre}}</strong></div>
