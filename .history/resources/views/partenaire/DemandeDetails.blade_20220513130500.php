    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header text-right">Demande du client : <strong>{{$demande->userDemande->nom_complet}}</strong> pour l'annonce <strong>{{$annonce->titre}}</strong></div>
                                ...
                                <div class="card">
                                    <div class="card-header gradInverse">
                                        <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link text-red" href="#annonce" role="tab" aria-controls="annonce" aria-selected="false">Détails de l'annonce</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-red" href="#vehicule" role="tab" aria-controls="vehicule" aria-selected="false">Détails de véhicule</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
