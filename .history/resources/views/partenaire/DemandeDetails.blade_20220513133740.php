    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">Demande du client : <strong class=" text-right">{{$demande->userDemande->nom_complet}}</strong> pour l'annonce <strong class=" text-right">{{$annonce->titre}}</strong></div>
