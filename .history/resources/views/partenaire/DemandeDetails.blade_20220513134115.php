                                ...
                                <div class="card">
                                    <div class="card-header gradInverse">
                                        <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " href="#annonce" role="tab" aria-controls="annonce" aria-selected="false">Annonce associée</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="#vehicule" role="tab" aria-controls="vehicule" aria-selected="false">Véhicule associée</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
