                                    ...
                                    <div class="card-body">
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane active" id="demande" role="tabpanel">
                                                <div class="row">
                                                    <strong><div class="col-md-5">Date de début de location</div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->date_debut}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Date de fin de location : </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->date_fin}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Prix total de location : </div></strong>
                                                    <div class="col-md-1">:</div>
                                            ...
                                            <div class="tab-pane" id="annonce" role="tabpanel" aria-labelledby="annonce-tab">
                                                <div class="row">
                                                    <strong><div class="col-md-5">Titre </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->titre}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Description </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->description}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Prix par jour </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->prix_par_jour}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Date début </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->date_desponibilite}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Date Fin </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">à ajouter </div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Ville </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->ville }}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Type d'annonce </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->premium==1 ? " Premium pour ".$annonce->duree_premium."" : "Normale"}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Type de véhicule </div></strong>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->type_vehicule}}</div>
                                                </div>
                                                <div class="row">
                                                    <strong><div class="col-md-5">Publié le  </div></strong>
                                                    <div class="col-md-1">:</div>
