                                    ...
                                    <div class="card-body">
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane active" id="demande" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Date de début de location</strong></div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->date_debut}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Date de fin de location :</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->date_fin}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Prix total de location :</strong> </div>
                                                    <div class="col-md-1">:</div>
                                            ...
                                            <div class="tab-pane" id="annonce" role="tabpanel" aria-labelledby="annonce-tab">
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Titre</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Prix par jour</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->prix_par_jour}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Date début</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->date_desponibilite}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Date Fin</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">à ajouter </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Ville</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->ville }}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Type d'annonce</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->premium==1 ? " Premium pour ".$annonce->duree_premium."" : "Normale"}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Type de véhicule</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$annonce->type_vehicule}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5"><strong>Publié le  </strong></div>
                                                    <div class="col-md-1">:</div>
