                                                ...
                                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                    <div class="carousel-inner">
                                                        ...
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100" src="{{asset('images\partenaireUploads\Voitures\.$image')}}" alt="First slide">
                                                        </div>
                                                        @endforeach
                                                        @endif
                                                        ...
                                                        @foreach($images as $image)
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100" src="{{asset('images\partenaireUploads\Motos\.$images')}}" alt="First slide">
                                                        </div>
                                                        @endforeach
                                                        @endif
                                                        @if($annonce->type_vehicule=="voiture")
                                                        @foreach($images as $image)
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100" src="{{asset('images\partenaireUploads\Vélos\.$images')}}" alt="First slide">
                                                        </div>
                                                        @endforeach
                                                        @endif
                                                    </div>
