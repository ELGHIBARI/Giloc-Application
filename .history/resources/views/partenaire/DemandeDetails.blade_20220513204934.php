                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 justify-center mt-2">
                                        <a class="btn btn-warning" href="{{ url('/demande/accept/',$id_demande) }}">
                                            Accepter
                                        </a>
                                    </div>
                                    <div class="col-md-6 justify-center mt-2">
                                        <a class="btn btn-primary" href="{{ url('/demande/refuse/' . $id_demande) }}">
                                            Refuser
                                        </a>
                                    </div>
                                </div>
