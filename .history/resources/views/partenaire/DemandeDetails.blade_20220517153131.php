    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @php $id_annonce=$demande->userAnnonce->id; @endphp
                @php $id_demande=$demande->id; @endphp
                <div class="card-header text-right">Demande du client : <strong class="text-red">{{$demande->userDemande->nom_complet}}</strong> pour l'annonce <strong class=" text-red">{{$demande->userAnnonce->titre}}</strong></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="tab-content mt-3">
                                            ...
                                            <div class="tab-pane" id="annonce" role="tabpanel" aria-labelledby="annonce-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->titre}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Description</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->description}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Prix par jour</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->prix_par_jour}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Date début</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->date_desponibilite}}</div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->ville }}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Type d'Annonce</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->premium==1 ? " Premium pour ".$demande->userAnnonce->duree_premium."" : "Normale"}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Type de véhicule</strong> </div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{$demande->userAnnonce->type_vehicule}}</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-5">Publiée le </strong></div>
                                                    <div class="col-md-1">:</div>
                                                    <div class="col md-6">{{ $demande->userAnnonce->created_at }}</div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6  mt-2">
                                        <a class="btn btn-primary float-left" href="{{ url('/demande/refuse/' . $id_demande . '/'.$id_annonce) }}">
                                            Refuser
                                        </a>
                                    </div>
                                </div>
