...
<div class="container w-100 ">
    <div class="row  justify-content-center">
                        ...
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                ...
                                <tr class='clickable-row'>
                                    <td id="td">{{$rate['client']['nom_complet']}}</td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td>
                                        ...
                                        <!-- The Modal -->
                                        <div id="myModal" class="modal eval{{$rate['id']}}">
                                            <!-- Modal content -->
                                                ...
                                                <form method="POST" action="{{ url('evaluer/'.$rate['id'])}}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-check mb-1  form-switch mr-4">
                                                            ...
                                                            <label class="form-check-label  mr-5" for="flexSwitchCheckChecked">Ajouter Commentaire</label>
                                                        </div>
                                                        <!-- div de commentaire -->
        ...
        <div class=" mt-2 col-md-10">
            <div class="card">
                <div class="card-header text-right mytable" id="btn-2" style="background-color:cornsilk">Historique des evaluations clients</div>
        ...
        <div class="col-md-10 mt-3">
            <div class="card">
                <div class="card-header text-right mytable" id="btn-3" style="background-color:cornsilk">{{ __('Historique des evaluations de votre objet') }}</div>
        ...
        <div class="col-md-10 mt-3">
            <div class="card">
                <div class="card-header text-right mytable" id="btn-4" style="background-color:cornsilk">{{ __('La liste de vos evaluations ') }}</div>
