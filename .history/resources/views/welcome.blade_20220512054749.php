...
<head>
    ...
    <style>
        ...
        .navcolor {
            background-color: #2c2b02;
            background-image: linear-gradient(120deg, #ffb700, #d6d0c6);        }
        footer{
...
<body class="antialiased">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ml-3 mt-0">
                    <a href="{{ route('login') }}" class="btn  red rounded-pill nav-link links">Se connecter</a>
                </li>
                @if (Route::has('register'))
                <li class="nav-item mt-0">
                    <a href="{{ route('register') }}" class="btn  btn-warning rounded-pill nav-link links">S'inscrire</a>
                </li>
                @endif
                @endauth
            </ul>
    ...
    <section>
        <h1 class="text-center">GILOC : Application de location de véhicules</h1>
        <div class="container text-center ">
            <h3 class="mb-5"> les choix que vous faites
            </h3>
