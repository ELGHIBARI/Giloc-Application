...
<body class="antialiased bg-light">
    ...
    <section>
        <h1 class=" mt-5 text-center" style="color : #bc3906; text-shadow: 0 0 5px #fad4d4 ">GILOC : Application de location de véhicules</h1>
        <div class="container text-center ">
            <h3 class="mb-5" style="color : #fad4d4; text-shadow: 0 0 2px #697009 "> les choix que vous faites
            </h3>
