...
<body class="antialiased bg-light">
    ...
    <section>
        <h1 class=" mt-5 text-center" style="color : #bc3906; text-shadow: 0 0 5px #fad4d4 ">GILOC</h1>
        <div class="container text-center ">
            <h3 class="mb-5" style="color : #697009; text-shadow: 0 0 2px #697009 "> les choix que vous faites
            </h3>
            <h5>
                Qui sommes-nous ? Giloc est une application de location de voiture qui vous permet de louer des véhicules ou mettre en location vos véhicule
            </h5>
            <h4 class="mb-5">
                Comment ?
            </h4>
            <h5>
                Selo vos besoins vous pouvez créer soit un compte client ou un compte partenaire
            </h5>
            <h4> le compte client : vous permet de consulter les annonces postées par les partenaire est réserver les véhicule qui vous intéresse 
                 GILOC assure la communication avec le partenaire pour terminer la procédure.
