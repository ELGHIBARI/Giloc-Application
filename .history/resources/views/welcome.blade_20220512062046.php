...
<body class="antialiased bg-light">
    ...
    <section>
        ...
        <div class="container text-center ">
            ...
            <h5>
                Qui sommes-nous ? Giloc est une application de location de véhicules qui vous de permet de louer des véhicules ou mettre en location vos véhicule
            </h5>
            <h4 class="mb-5">
                Comment ?
            </h4>
            ...
            <h5> le compte client : vous permet de consulter les annonces postées par les partenaire est réserver les véhicule qui vous intéresse 
