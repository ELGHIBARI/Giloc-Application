...
<body class="antialiased bg-light">
    ...
    <section>
        ...
        <div class="container text-center ">
            ...
            <h5  style="color : #697009; text-shadow: 0 0 2px #697009 ">
            ...
            <h4 style="color :#bc3906; text-shadow: 0 0 5px #fad4d4 ;">
                Comment ?
            </h4>
            <h5>
                Selo vos besoins vous pouvez créer soit un compte client ou un compte partenaire
            </h5 >
           <em> <h5 style="color :#bc3906; "> le compte client : vous permet de consulter les annonces postées par les partenaire est réserver les véhicule qui vous intéresse 
