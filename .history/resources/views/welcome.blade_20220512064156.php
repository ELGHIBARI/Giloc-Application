...
<body class="antialiased bg-light">
    ...
    <div class="container mt-2">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header headcrd text-right"></div>
                    <div class="card-body text-right">
                        <h1 class=" mt-2 text-center" style="color : #bc3906; text-shadow: 0 0 5px #fad4d4 "><img src="{{ asset('img/logo (2).png') }}" alt="giloc" style="width : 60% ; "></h1>
                    ...
                    <div class="card-footer fottcard"></div>
                </div>
            </div>
        </div>
    </div>
