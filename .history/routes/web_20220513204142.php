...
Route::get('demande/details/{id}', [DemandeController::class, 'show']);
Route::get('demande/accept/{id}', [DemandeController::class, 'index']);
Route::get('demande/refuse/{id}', [DemandeController::class, 'show']);
