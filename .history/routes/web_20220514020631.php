...
Route::get('demande/details/{id_annonce}/{id_client}', [DemandeController::class, 'show']);
Route::get('demande/accept/{id_demande}/{id_annonce}/{id_demande}', [DemandeController::class, 'accept']);
