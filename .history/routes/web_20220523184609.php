...
Route::get('/partenaires/{id}/archiver', [App\Http\Controllers\PartenaireController::class, 'archiver'])->name('clients.archiver');
Route::get('/profile', [App\Http\Controllers\ProfileController::class, 'index'])->name('profile');
Route::put('/profile/update', [App\Http\Controllers\ProfileController::class, 'update'])->name('profile.update');
Route::get('/clients', [App\Http\Controllers\ClientController::class, 'index'])->name('clients');
Route::get('/clients/{id}/archiver', [App\Http\Controllers\ClientController::class, 'archiver'])->name('clients.archiver');
Route::get('/annonce', [App\Http\Controllers\AnnonceController::class, 'index1'])->name('annonce');
Route::post('/annonce/annonce_admin', [AnnonceController::class,'annonce_details'])->name('annonces.annonce_admin');
Route::get('/annonces/{id}/destroy', [App\Http\Controllers\AnnonceController::class, 'destroy'])->name('annonces.destroy');