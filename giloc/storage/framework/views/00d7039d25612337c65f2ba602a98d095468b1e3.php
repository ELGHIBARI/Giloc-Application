...
<link href="<?php echo e(asset('css/AddAnnonceStyle.css')); ?>" rel="stylesheet">
<script type="text/javascript" src="<?php echo e(asset('js/AddAnnonceStyle.js')); ?>"></script>
                ...
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                            <form method="POST" action="<?php echo e(url('annonce/store')); ?>" id="msform" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <!-- progressbar -->
                                <ul id="progressbar">
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='modeleAnnee'>
                                                ...
                                                <input id="inAnnee" type='number' class='form-control' min="1900" max="<?php echo e(now()->year); ?>" name='modelAnnee' />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style='display:none;' id='anneeMoto'>
                                                ...
                                                <input id="inAnneeMoto" type='number' class='form-control' name='anneeMoto' min="1900" max="<?php echo e(now()->year); ?>" />
                                            </div>
...
<?php else: ?>
<script>
    alert("vous avez un maximum de cinq annonce");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prog web 2\giloc\resources\views/partenaire/addannonce.blade.php ENDPATH**/ ?>