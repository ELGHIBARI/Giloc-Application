...
<body class="antialiased bg-light">
    <nav class="navbar navbar-expand-lg bg-light navcolor shadow-sm">
        <a class="navbar-brand" href="#">
            <img src="<?php echo e(asset('img/logo (2).png')); ?>" alt="giloc">
        </a>
    ...
    <div class="container mt-2">
        <div class="row justify-content-center">
            <div class="row">
                <div class="col-md-2"> <img src="<?php echo e(asset('img/pat1.jpg')); ?>" alt="giloc"></div>
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body card bg-light shadow-sm">
                            <h1 class=" mt-2 text-center" style="color : #bc3906; text-shadow: 0 0 5px #fad4d4 "><img src="<?php echo e(asset('img/logo (3).png')); ?>" alt="giloc"></h1>
                ...
                <div class="col-md-2 float-left"> <img src="<?php echo e(asset('img/part2.jpg')); ?>" alt="giloc"></div>
            </div>
        </div>
    </div>
</body>
<footer class="py-2 bg-light footer fixed-bottom ">
    <div class="row">
        <div class="col-md-4 my-auto">
            <center>
                <img src="<?php echo e(asset('img/output-onlinepngtools.png')); ?>" width="30" height="30" />
                GIloc@location.com
            </center>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4 my-auto">
            <center>
                <img src="<?php echo e(asset('img/tele.jpg')); ?>" width="30" height="30" />
                +212 512345678
            </center>
        </div>
</footer>

</html><?php /**PATH C:\xampp\htdocs\prog web 2\giloc\resources\views/welcome.blade.php ENDPATH**/ ?>