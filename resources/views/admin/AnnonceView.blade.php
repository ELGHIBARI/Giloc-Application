...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="col-xl-12 ml-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-4">Demandes </h4>
                    @if($client!=null)
 ...
 @foreach($client as $c)
                                <div class="activity-icon avatar-sm">
                                    <img src="/images/avatar/{{$c->avatar}}" class="avatar-sm rounded-circle" alt="">
                                </div>
                                <div class="media">
                                    <div class="me-3">
                                       
                                        <h5 class="font-size-15 mb-1">{{$c->nom_complet}}</h5>
                                        <h6 class="font-size-15 mb-1">{{$c->nom_ville}}</h6>
    ...
    <div class="col-md-8 ">
        <div class="container">
            <div class="card" style="background-color:#f6e58d ;">
                <div class="card-body">
                    <a onclick="return confirm('confirmer?')" href="{{url('/annonces/'.$annonces_voiture[0]['id'].'/destroy')}}"><i class="fa fa-archive font-size-15 text-danger"></i></a>
                    <div class="row">
    ...
    <div class="col-md-8 ">
        <div class="container">
            <div class="card" style="background-color:#f6e58d ;">
                <div class="card-body">
                <a onclick="return confirm('confirmer?')" href="{{url('annonces/'.$annonces_moto[0]['id'].'/destroy')}}"><i class="fa fa-archive font-size-15 text-danger"></i></a>
                    <div class="row">
                        <div class="card-title d-block w-75">
    ...
    <div class="col-md-8 ">
        <div class="container">
            <div class="card" style="background-color:#f6e58d ;">
                <div class="card-body">
                <a onclick="return confirm('confirmer?')" href="{{url('/annonces/'.$annonces_velo[0]['id'].'/destroy')}}"><i class="fa fa-archive font-size-15 text-danger"></i></a>
                    <div class="row">
                        <div class="card-title d-block w-75">
